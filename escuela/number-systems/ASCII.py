#print(chr(64)) convierte de ASCII a caracter
#print(ord("@")) convierte
#dic={"@":64, "ñ":241,"Ñ":209,"¿":191, "¡": 161, "/":92, "~":126, '"':34, "'": 39, "(":123, "}":125, "[":91, "]":93, "^":94, "_":95, "$":36}
...
palabra=input("Ingrese una palabra para pasar a ASCII: ")
cadena = ""
for i in range(len(palabra)):
    for clave in ascii_imprimibles:
        if clave==palabra[i]:
            cadena=cadena+" "+ str(ascii_imprimibles[clave])
            
print("El mensaje '" + palabra + "' en ASCII es: " + cadena)
